    ...
    private val okHttpClient = OkHttpClient.Builder()
        ...
        .addInterceptor { chain ->
            val requestBuilder = chain.request().newBuilder()
                .header("Authorization", "token 4eca2907759d2db456df24eaf0d29426634431b6")
...
//        .writeTimeout(TIMEOUT_MS, TimeUnit.SECONDS)         // 읽기 타임 아웃의 반대 방향, 얼마나 빨리 서버에 바이트를 보낼 수 있는지 확인.
    ...
    val API_GITHUB_SERVICE: ApiGithubService by lazy {
        githubAdapter.create(ApiGithubService::class.java)
    }
