...
sealed class MainViewEvent {
    data class UsersItemClicked(val item: User) : MainViewEvent()
    object FabClicked : MainViewEvent()
    object OnSwipeRefresh : MainViewEvent()
    object FetchUsers : MainViewEvent()
}
 ...
 */
data class MainViewState(val fetchStatus: FetchStatus, val userList: List<User>)
